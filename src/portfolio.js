...
const greeting = {
  ...
  resumeLink: "https://drive.google.com/file/d/1iI605kZS0SgvwQohrXKEBD0e6IiRT7RE/view?usp=drive_link", // Replace with your actual resume link
...
const socialMediaLinks = {
  ...
  linkedin: "https://www.linkedin.com/public-profile/settings?trk=d_flagship3_profile_self_view_public_profile", // Replace with your LinkedIn profile
...
const skillsSection = {
  ...
  skills: [
    emoji("⚡ Develop secure and dynamic web applications using ASP.NET MVC and .NET Core"),
    emoji("⚡ Build and integrate high-performance APIs with robust security and encryption"),
    emoji("⚡ Create responsive front-end interfaces with HTML5, CSS, Bootstrap, and JavaScript"),
    emoji("⚡ Design and optimize database systems using MS SQL Server and Entity Framework")
  ],
  softwareSkills: [
  ...
  projects: [
    {
      ...
      projectDesc: "Integrated Ayushman Bharat Digital Mission (ABDM) API to create a secure healthcare infrastructure, focusing on data privacy and encryption.",
      footerLink: [
    ...
    },
    {
      ...
      projectDesc: "Developed a lab management system with client registration, subscription-based limits, and data reporting features.",
      footerLink: [
    ...
    },
    {
      ...
      projectDesc: "Built a Laboratory Information Management System (LIMS) with patient management, billing, and secure payment integration using ICICI PayU.",
      footerLink: [
    ...
    },
    {
      ...
      projectName: "Elabapi",
      projectDesc: "Created a high-performance API system using .NET Core with caching for efficient handling of large datasets.",
      footerLink: [
    ...
    },
    {
      ...
      projectDesc: "Enhanced user engagement with features like likes, comments, and job postings for an educational social platform.",
      footerLink: [
    ...
    },
    {
      ...
      projectDesc: "Developed a system for managing educational courses, including registration, scheduling, and communication features.",
      footerLink: [
        { name: "GitHub", url: "https://github.com/your-username/batch-management" } // Replace with actual repo link
      ]
    }
  ],
  display: true // Set false to hide this section, defaults to true
